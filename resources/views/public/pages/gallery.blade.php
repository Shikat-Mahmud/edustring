        ...
        <div
                    ...
                    @foreach ($galleries as $gallery)
                        <div class="space-y-[30px] lg:space-y-[20px]">
                            <div
                                ...
                                <img src="{{ $gallery->photo ? asset('storage/' . $gallery->photo) : asset('web/img/gallery-img-1.jpg') }}"
                                    alt="gallery image" class="w-full aspect-square object-cover">
                                <a href="{{ $gallery->photo ? asset('storage/' . $gallery->photo) : asset('web/img/gallery-img-1.jpg') }}"
            ...
            @else
                <div class="flex items-center justify-center flex-col">
                    <img src="{{ asset('/') }}images/empty.jpg" alt="Photo"
                        style="height: 300px; width: auto; margin-bottom: 20px;">
                    <h5 class="text-center text-secondary">There is no image in your gallery!</h5>
                </div>
            @endif
        </div>
    </div>
