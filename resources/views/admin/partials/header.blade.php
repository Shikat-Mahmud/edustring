                    ...
                    <div class="dropdown-menu pc-h-dropdown drp-search">
                        <form id="search-form" class="px-3">
                            <div class="form-group mb-0 d-flex align-items-center">
                                <input type="search" id="search-input" class="form-control border-0 shadow-none"
                                    placeholder="Search here. . .">
                                <button type="button" class="btn btn-light-secondary btn-search"
                    ...
                    <a class="pc-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#"
                        ...
                        @if(isset(auth()->user()->photo))
                            <img src="{{ asset('storage/' . auth()->user()->photo) }}"
                                style="height: 40px; width:40px; object-fit: cover; border-radius: 50%;" alt="user-image">
                        @else
