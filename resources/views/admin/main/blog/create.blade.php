                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('blogs.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mt-3">
                                    <label for="content" class="col-md-4">Content: <span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                                        <textarea name="content" id="content" class="form-control" rows="6" placeholder="Blog Content Here..." required></textarea>
                                    </div>
                                </div>
                                <div class="row mt-3">
