                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-5 mt-3">
                                    <label class="col-sm-4 col-form-label"> Logo (For dark background): </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <div class="input-group">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                @if (isset($general->logo_light))
                                                    <img src="{{ asset('storage/' . $general->logo_light) }}" alt="Logo Light"
                                                        style="height: 50px; border-radius: 6px;">
                                                @else
                                                    <p>There is no Logo Light. You can upload new one.</p>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
