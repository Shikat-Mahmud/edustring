            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('invests.index') }}" class="btn btn-primary btn-sm"><i class="fas fa-arrow-left mr-2 "></i> Investment List</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('invests.update', $invest->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row mt-3">
